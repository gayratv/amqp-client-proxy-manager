...
declare module "helpers/mysql-helper" {
    ...
    export function retriableQuery<T extends RowDataPacket[][] | RowDataPacket[] | OkPacket | OkPacket[] | ResultSetHeader>(sql: string, values?: any | any[] | {
        [param: string]: any;
...
declare module "rmq-request-responce/clients/proxy-get" {
    import { GetProxyReturn } from "rmq-request-responce/types/types";
    export class ProxyGet {
        private instanceRMQ_proxyClientQuery;
        private instance;
        private constructor();
        static getInstance(): Promise<ProxyGet>;
        getProxy(leasedTime: number): Promise<GetProxyReturn>;
        returnProxy(p1: GetProxyReturn): Promise<void>;
    }
}
